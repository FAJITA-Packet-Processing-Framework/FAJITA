 ...
 *
 */
class FlowIPManagerPrefetch: public VirtualFlowManager, public Router::ChildrenFuture {
    public:
    ...
    protected:
        ...
        int _flags;
	int _prefetch;
	bool _prefetch_secondary;
	int _prefetch_lvl;
	void *_prefetched_keys[64];
	int _maxIndex;
	int _currentIndex;
        ...
        Task _task;
        bool _cache;
	bool _prefetch_batch;
        bool _bulk_search;
        static String read_handler(Element* e, void* thunk);
        inline void process(Packet* p, BatchBuilder& b, const Timestamp& recent, int bulk_ret);
